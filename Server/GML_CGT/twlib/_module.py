...
class _module:
    ...
    def get(a_fun, a_db, a_module, a_module_type, a_id_list, a_field_sign_list, a_limit="5000", a_order_sign_list=[]):
        ...
        t_data_list=a_fun("c_orm", "get_in_id", {"db":a_db, "module":a_module, "module_type":a_module_type, "sign_array":t_field_sign_list, "id_array":a_id_list, "limit":a_limit, "order_sign_array":a_order_sign_list})
        t_result_list=[]
    ...
    def count(a_fun, a_db, a_module, a_module_type, a_filter_list):
        ...
        t_filter_list=_module.__change_filter(a_module, a_module_type,  a_filter_list)
        return a_fun("c_orm", "get_count_with_filter", {"db":a_db, "module":a_module, "module_type":a_module_type, "sign_filter_array":t_filter_list})
    ...
    def distinct(a_fun, a_db, a_module, a_module_type, a_filter_list, a_field_sign, a_order_sign_list=[]):
        ...
        t_filter_list=_module.__change_filter(a_module, a_module_type,  a_filter_list)
        t_data_list=a_fun("c_orm", "get_distinct_with_filter", {"db":a_db, "module":a_module, "module_type":a_module_type, "distinct_sign":a_field_sign, "sign_filter_array":t_filter_list, "order_sign_array":a_order_sign_list})	
        t_result_list=[]
    ...
    @staticmethod
    def update_flow(a_fun, a_http_ip, a_cgtw_path, a_token, a_db, a_module, a_module_type, a_id, a_field_sign, a_status, a_note="", a_image_list=[]):
        if not isinstance(a_http_ip, (str, unicode)) or not isinstance(a_cgtw_path, (str, unicode)) or not isinstance(a_token, (str, unicode)) or not isinstance(a_db, (str, unicode)) or not isinstance(a_module, (str, unicode)) or not isinstance(a_module_type, (str, unicode)) or \
           not isinstance(a_id, (str, unicode)) or not isinstance(a_field_sign, (str, unicode)) or not isinstance(a_status, (str, unicode)) or not isinstance(a_note, (str, unicode)) or not isinstance(a_image_list, list):
    ...
    def fields(a_fun, a_db, a_module, a_module_type):
        if not isinstance(a_db, (str, unicode)) or not isinstance(a_module, (str, unicode)) or not isinstance(a_module_type, (str, unicode)):
    ...
    def group_count(a_fun, a_db, a_module, a_module_type, a_field_sign_list, a_filter_list):
        if not isinstance(a_db, (str, unicode)) or not isinstance(a_module, (str, unicode)) or not isinstance(a_module_type, (str, unicode)) or not isinstance(a_field_sign_list, list) or not isinstance(a_filter_list, list):
            raise Exception("_module.group_count argv error,  must be( str, str, str, list, list)")      
        
        t_filter_list=_module.__change_filter(a_module, a_module_type,  a_filter_list)
        t_data_list=a_fun("c_orm","get_group_count_with_filter",{"db":a_db, "module":a_module, "module_type":a_module_type, "sign_array":a_field_sign_list, "sign_filter_array":t_filter_list})
        t_result_list=[]
        for t_data in t_data_list:
            t_tmp_dict={}
    ...
    def __fields(a_fun, a_db, a_module, a_module_type, a_field_array):
        if not isinstance(a_db, (str, unicode)) or not isinstance(a_module, (str, unicode)) or not isinstance(a_module_type, (str, unicode)) or not isinstance(a_field_array, list):
            raise Exception("_module.__fields argv error,  must be( str, str, str, list)")  
        return a_fun("c_field","get_join_module_data", {"db":a_db, "module":a_module, "module_type": a_module_type, "field_array":a_field_array, "order_field_array":["module", "sort_id"]})
